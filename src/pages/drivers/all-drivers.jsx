...
const AllDrivers = () => {
  ...
  //useEffect
  useEffect(() => {
    setData(driversData.slice(firstRow, lastRow));
  }, [firstRow, lastRow]);
  //set next page
  const nextPage = () => {
    if (lastRow >= driversData.length) {
      return;
    }
                ...
                {data.map((_, i) => {
                  return (
                    <TableRow key={i + "-table-view"}>
                      ...
                      <TableCell className="break-all">{_.email}</TableCell>
                      <TableCell>{_.address}</TableCell>
                      <TableCell>{_.joining_date}</TableCell>
                      <TableCell>{_.no_of_trips}</TableCell>
                      <TableCell>
                        <Badge
                          variant={
                            _.status === "AVAILABLE"
